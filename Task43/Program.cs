...
double[] lineData1 = InputDataLine(LINE1);
double[] lineData2 = InputDataLine(LINE2);

if (Validatelines(lineData1, lineData2))
{
    double[] coord = FindCoords(lineData1, lineData2);
    Console.WriteLine(@$"точка пересечения уравнений:
    y = {lineData1[COEFFICIENT]} * x + {lineData1[CONSTANT]}
...
double[] InputDataLine(int numberOfLine)
{
